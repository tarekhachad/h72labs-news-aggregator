 ...
 * shorter than the real animation it would retire a card mid-flight: a card
 * retired while animating loses its `animate` target and freezes part-faded. A
 * comment asserting "these must match" is
