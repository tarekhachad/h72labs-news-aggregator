...
Result: **sev ≥ 3 = 99 against a baseline of 101**, in band. Pass rate 29.3% remained out of band — but 105 of the 110 severity-2 passes were discarded by the cap, so it is a labelling difference, not a calibration regression. That interpretation was fixed in advance of the run, not chosen after seeing it. **Cost \$0.335**, missing the ≤\$0.30 target and accepted at Tarek's call. Expands measured for the first time at ~\$0.012/card. *(Corrected 2026-09-11: recorded at the time as "\$0.399 at list / \$0.335 billed / ~\$0.017 per expand". Sonnet 5's scheduled 2026-09-01 increase was cancelled, so the billed column is the only column.)* Full write-up in `notes-logs/(C) cost-diagnosis-2026-08-15-post-optimization.md`.
